    ...
    public CannonballRun(String filename) throws FileNotFoundException {
        ...
        while (in.hasNextLine()) {
            ...
            if (fields[0].equals("Road")) {
                road = new Road(fields[1], Integer.valueOf(fields[2]));
                ...
                Vehicle vehicle = new Vehicle(fields[1],
                        Integer.valueOf(fields[2]), Double.parseDouble(fields[3]),
    ...
    public void run() {
        ...
        while (!weHaveAWinner) {
            ...
            for (Vehicle vehicle : road.getVehicles()) {
                ...
                // find the vehicle that is in the lead based on its location on the road
            ...
            for (Vehicle vehicle : road.getVehicles()) {
                // the winner of the race is the first to reach the end of the road
