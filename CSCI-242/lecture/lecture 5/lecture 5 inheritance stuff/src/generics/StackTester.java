...
/**
 * A test program for StackList and StackNode.  NOTE!!! You need to specify
 * in the run configuration for VM Options -> "-ea" to enable the assert
 * exception.
 *
 *  Usage: java StackTester [list | node]
 *
