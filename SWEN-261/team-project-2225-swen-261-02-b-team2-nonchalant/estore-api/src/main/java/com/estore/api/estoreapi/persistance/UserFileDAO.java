...
public class UserFileDAO implements UserDAO {
    ...
    private boolean load() throws IOException {
      ...
      //  testCart.add(new Product(4, "testproduct", 23, 45));
       // User testUser = new User(5, "testadd", testCart);
       // createUser(testUser);
        //save();
       //above is the creation of a test user object and adding it to json. dont question why its here. 
        users = new TreeMap<>();
        nextId = 0;
    ...
    ** {@inheritDoc}
    ...
    public User createUser(User user) throws IOException {
        synchronized(users) {
            ...
            User newUser = new User(nextId(),user.getName(), prods);
